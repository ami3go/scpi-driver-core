"""Robot Framework adapter for :mod:`py_eresistor_driver`.
...
from py_eresistor_driver import EResistorClient, discover_boards, discover_boards_auto
from py_eresistor_driver.profile import load_profile
from py_eresistor_driver.validation import normalize_mask
...
class EResistorLibrary:
    ...
    def _trace_client_protocol(self, client: EResistorClient) -> None:
        ...
        — ``py_eresistor_driver`` itself (used standalone via its own CLI) is
