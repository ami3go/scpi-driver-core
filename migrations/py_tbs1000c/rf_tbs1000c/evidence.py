...
this driver's own exception hierarchy in ``py_tbs1000c/exceptions.py``).
"""
...
def _classify_exception(exc: BaseException) -> str:
    """Approximate error category from py_tbs1000c/exceptions.py's own hierarchy.
...
class InstrumentedTransport:
    """Transparent :class:`py_tbs1000c.transport.Transport` wrapper.
