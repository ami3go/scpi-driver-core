...
from py_tbs1000c.codec import build_ieee_block, parse_curve_response
from py_tbs1000c.exceptions import (
    Tbs1000cConnectionError,
    Tbs1000cProtocolError,
    Tbs1000cTimeoutError,
)
from py_tbs1000c.transport import PyvisaUsbtmcTransport
...
def test_identity_parsing_still_tolerates_a_short_reply() -> None:
    from py_tbs1000c.codec import parse_idn
