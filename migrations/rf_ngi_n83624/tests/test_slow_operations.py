...
from ngi_n83624 import ChannelLimits, DriverSafetyPolicy, InstrumentLimits, N83624CellSimulator
from ngi_n83624.emulator import SimpleN83624Emulator
from ngi_n83624.exceptions import CommunicationError, SessionStateError, TimeoutError
...
def clock(monkeypatch: pytest.MonkeyPatch) -> FakeTime:
    fake = FakeTime()
    monkeypatch.setattr("ngi_n83624.driver.time", fake)
    return fake
