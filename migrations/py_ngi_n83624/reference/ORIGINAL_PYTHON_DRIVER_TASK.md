...
```python
import py_ngi_n83624
```

Main public class:

```python
from py_ngi_n83624 import N83624CellSimulator
```
...
1. Installable Python package with root-level `py_ngi_n83624/` package directory.
...
```python
from py_ngi_n83624 import N83624CellSimulator, FaultSimulationMode
