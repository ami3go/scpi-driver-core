...
Create a maintainable, safety-oriented Robot Framework library based on the supplied `py_ngi_n83624` Python driver. The deliverable shall expose stable Robot keywords for common N83624 workflows while retaining the typed Python driver as the SCPI and transport implementation layer.
...
├── py_ngi_n83624/             supplied core driver, reviewed and corrected
