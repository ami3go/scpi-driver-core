...
The library wraps the typed :mod:`py_ngi_n83624` Python driver and adds Robot-specific
...
from py_ngi_n83624.exceptions import SafetyError, SessionStateError, ValidationError
