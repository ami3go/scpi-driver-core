...
Protocol tracing works through ``py_ngi_n83624.driver.N83624CellSimulator.protocol_observer``
...
hierarchy (``py_ngi_n83624/exceptions.py``) since RFDS-007 itself was not
...
def _classify_exception(exc: BaseException) -> str:
    ...
    ``py_ngi_n83624/exceptions.py`` names (``ValidationError``, ``SafetyError``,
