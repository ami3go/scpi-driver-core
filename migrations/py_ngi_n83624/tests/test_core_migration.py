...
from py_ngi_n83624.exceptions import CommunicationError, TimeoutError, ValidationError
from py_ngi_n83624.transports import (
    SerialTransport,
    TcpTransport,
    UdpTransport,
    udp_channel,
...
def test_empty_commands_are_still_rejected() -> None:
    from py_ngi_n83624.transports import _encode_command
