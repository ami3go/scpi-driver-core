...
from agilent34411a.exceptions import Agilent34411AConnectionError, Agilent34411ATimeoutError
from agilent34411a.transport import PyvisaTransport
...
def test_identity_tolerates_a_partial_reply() -> None:
    ...
    from agilent34411a.driver import _identity_fields
...
def test_readings_parse_through_the_core() -> None:
    from agilent34411a.driver import Agilent34411A as Driver
