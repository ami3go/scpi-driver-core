...
being implemented here. Agilent 34411A speaks VISA, and all of that is the core's
byte-oriented transport layer with this package's device semantics on top.

What changed in the migration: py_agilent34411a/transport.py, plus identity and reading-burst parsing in driver.py. Everything else — the command tree,
