...
├── py_agilent34411a/            # hardware-agnostic core driver
│   ├── __init__.py
│   ├── exceptions.py
│   ├── enums.py
│   ├── models.py
...
- **`py_agilent34411a`** — hardware-agnostic core. Owns all SCPI command construction and
...
- [ ] Core driver (`py_agilent34411a`) implements connection lifecycle, all measurement
