...
def build_system_contract(version: str, release: str) -> dict[str, Any]:
    return {
        ...
        "physical_topology": {
            "instruments": [{"id": "n6700_mainframe_1", "driver_id": "py_keysight_n6700", "resource": N6775A_USB_RESOURCE, "transport": "usb_visa", "channels": [1, 2, 3, 4]}],
            "connections": [
        ...
        "signal_graph": {
            "nodes": [
                {"id": "n6700_ch1_4_dc", "type": "bidirectional_module_dependent_dc_port", "producer": "py_keysight_n6700", "quantities": ["voltage", "current", "power"]},
        ...
        "requirement_coverage": [
            {"requirement_pattern": "identify programmable power instrument", "drivers": ["py_keysight_n6700"], "verification_objectives": ["VO-IDENTITY", "VO-MODULE-MAP"]},
            {"requirement_pattern": "apply controlled DC voltage/current", "drivers": ["py_keysight_n6700"], "verification_objectives": ["VO-SAFE-START", "VO-SETPOINT", "VO-OUTPUT", "VO-SHUTDOWN"], "status": "BLOCKED_UNTIL_TOPOLOGY_CONFIGURED"},
            {"requirement_pattern": "measure channel voltage/current/power", "drivers": ["py_keysight_n6700"], "verification_objectives": ["VO-MEASUREMENT"], "traceability_note": "Add independent measurement driver when required."},
            {"requirement_pattern": "verify protection behavior", "drivers": ["py_keysight_n6700"], "verification_objectives": ["VO-PROTECTION", "VO-SHUTDOWN"], "status": "REQUIRES_APPROVED_FAULT_INJECTION_PLAN"},
        ],
        "test_templates": [
            {
