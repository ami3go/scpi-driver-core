...
from py_keysight_n6700.exceptions import N6700Error  # noqa: E402
...
TOLERATED = (N6700Error, NotImplementedError,)
...
def test_the_public_surface_is_not_empty() -> None:
    ...
    assert len(conformance.public_members(N6700)) > 10
...
def test_documentation_debt_does_not_grow() -> None:
    ...
    assert len(conformance.undocumented(N6700)) <= recorded
