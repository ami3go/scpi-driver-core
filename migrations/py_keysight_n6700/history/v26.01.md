...
**Archive:** `py_keysight_n6700_v26.01.zip`  
...
- Retained the original `py_keysight_n6700` Python driver, transport layer, capability model, and simulator.

## Package-format update

- Renamed the release archive to the project convention: `py_keysight_n6700_v26.01.zip`.
