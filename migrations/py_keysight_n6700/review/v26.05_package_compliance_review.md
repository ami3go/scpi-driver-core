...
The release uses `py_keysight_n6700_v26.05.zip` with fixed internal root `rf_keysight_n6700/` and retains all mandatory project folders and earlier release records.
