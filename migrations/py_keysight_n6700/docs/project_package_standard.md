...
The release archive is named `py_keysight_n6700_v26.09.zip` and always contains exactly one top-level folder: `rf_keysight_n6700/`.
...
python scripts/verify_project_package.py \
  --archive ../py_keysight_n6700_v26.09.zip \
