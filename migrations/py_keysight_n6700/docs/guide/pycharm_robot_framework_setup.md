...
Do not mark only `KeysightN6700Library/` as the project root, because the Robot adapter imports the sibling `py_keysight_n6700/` package.
...
python -m ruff check .
python -m mypy py_keysight_n6700 KeysightN6700Library
```
