...
`N6700.query_scpi()` in `py_keysight_n6700/driver.py`, which is the single
...
```python
from py_keysight_n6700 import N6700
...
shutdown sequences) can be recorded as a single `py_keysight_n6700.types.AuditRecord`
...
Markdown summary under `results/call_protocol_conformance/py_keysight_n6700/<UTC
