...
| RFDS-003 concrete-driver coverage >=80% | active adapter + embedded core | CI `pytest --cov=rf_hp34401a --cov=py_hp34401a_dmm --cov-fail-under=80` | PENDING final green CI |
...
| RFDS-008 fail-closed evidence | `py_hp34401a_dmm/evidence.py` | evidence unit/regression + validator | PASS implementation; current CI rerun pending |
