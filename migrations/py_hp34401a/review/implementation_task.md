...
- Python package: `py_hp34401a_dmm`
...
Implement a thin, typed Robot Framework adapter that delegates instrument behavior to `py_hp34401a_dmm.Hp34401A`. The Robot layer shall provide:
...
Develop a production-ready Robot Framework library for the HP/Agilent/Keysight 34401A DMM using the supplied `py_hp34401a_dmm` version 1.2.8 driver as the core implementation.
...
│   ├── exceptions.py
│   └── version.py
├── py_hp34401a_dmm/                 # Reviewed core driver, no src/ layout
├── tests/
│   ├── unit/
│   ├── robot/
│   ├── integration/
