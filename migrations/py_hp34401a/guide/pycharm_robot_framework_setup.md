...
It is the directory containing `pyproject.toml`, `rf_hp34401a/`, `py_hp34401a_dmm/`, `examples/`, `tests/`, and `scripts/`.
...
The active core facade is `py_hp34401a_dmm/driver.py`; the reviewed 1.2.8 implementation is in `py_hp34401a_dmm/legacy_driver.py`.
