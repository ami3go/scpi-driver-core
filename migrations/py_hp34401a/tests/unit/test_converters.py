...
from py_hp34401a_dmm import AutoRange, InputTerminal, Nplc, TriggerSource
...
def test_extended_converter_paths():
    from py_hp34401a_dmm import AcFilterHz, Aperture, AutozeroMode
    from rf_hp34401a.converters import (
        as_ac_filter,
        as_aperture,
        as_autozero,
...
def test_enum_instance_and_remaining_error_paths():
    from py_hp34401a_dmm import AutoRange, AutozeroMode, InputTerminal, TriggerSource
