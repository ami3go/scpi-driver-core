...
from py_hp34401a_dmm import MeasurementNotStableError
...
def test_open_via_visa_and_serial_factory_paths(monkeypatch):
    from py_hp34401a_dmm import DriverConfig, FakeTransport, Hp34401A
...
def test_failure_branches_for_model_selftest_invalid_reading_and_cleanup(monkeypatch):
    from py_hp34401a_dmm import MeasurementFunction, MeasurementReading
