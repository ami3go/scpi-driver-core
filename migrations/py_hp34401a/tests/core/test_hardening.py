...
from py_hp34401a_dmm.driver import estimate_measurement_timeout_s
from py_hp34401a_dmm.enums import MeasurementFunction
from py_hp34401a_dmm.visa_transport import validate_gpib_resource
...
def test_r2_garbled_idn_raises_settings_diagnostic():
    ...
    t._transport_type = __import__("py_hp34401a_dmm").TransportType.SERIAL_RS232
...
def test_r10_visa_config_validates_on_construction():
    from py_hp34401a_dmm.visa_transport import VisaGpibTransport
    with pytest.raises(InstrumentConnectionError):
...
def test_real_transport_timeout_keeps_unread_output_until_clear():
    from py_hp34401a_dmm.transports import BaseTransport
    from py_hp34401a_dmm.enums import TransportType
    from py_hp34401a_dmm.errors import InstrumentTimeoutError, ProtocolError
...
def test_production_value_error_becomes_error_result():
    from py_hp34401a_dmm import TestStep, run_measurement_step
...
def test_visa_wrong_identity_rejected_on_connect():
    ...
    t._transport_type = __import__("py_hp34401a_dmm").TransportType.VISA_GPIB
...
def test_serial_partial_response_is_timeout():
    from py_hp34401a_dmm.serial_transport import SerialRs232Transport
    from py_hp34401a_dmm.config import SerialRs232Config
...
def test_gui_module_import_safe():
    import py_hp34401a_dmm.gui as gui
