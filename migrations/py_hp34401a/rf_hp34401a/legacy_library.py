...
carried it. See ``py_hp34401a_dmm/evidence.py`` for what gets recorded and where;
...
from py_hp34401a_dmm import evidence as _evidence
...
class Hp34401ALibrary:
    ...
    The library delegates all SCPI operations to ``py_hp34401a_dmm.Hp34401A``.
    ...
    alias. See ``py_hp34401a_dmm/evidence.py`` and ``docs/logging_and_evidence.md``.
    """
