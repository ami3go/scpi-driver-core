...
The unattended profile uses `py_hp34401a_dmm.FakeTransport`. It records writes, queries, raw responses, and transport clears at the same line-oriented SCPI boundary used by the production driver. Internal adapter-method mocking is not used as the protocol oracle.
