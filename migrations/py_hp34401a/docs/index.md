...
Release 26.07 adds an RFDS-008 structured evidence engine (`py_hp34401a_dmm/evidence.py`) — every public keyword call is now recorded with correlated arguments, duration, and the underlying SCPI traffic, finalized into a SHA-256-hashed manifest for troubleshooting. See [Logging and Evidence](logging_and_evidence.md). This added one new keyword, `Export Diagnostic Bundle`, bringing the public API to 109 keywords.
