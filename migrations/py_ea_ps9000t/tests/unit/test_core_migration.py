...
from py_ea_ps9000t.driver import EaPs9000T, _identity_parts, _parse_float, _parse_number
from py_ea_ps9000t.exceptions import EaPs9000TConnectionError, EaPs9000TTimeoutError
from py_ea_ps9000t.transport import PyvisaTransport
...
def test_a_response_with_no_number_still_raises() -> None:
    from py_ea_ps9000t.exceptions import EaPs9000TProtocolError
...
def test_the_core_handles_the_unit_suffix_without_the_fallback(
    ...
    """
    import py_ea_ps9000t.driver as driver_module
