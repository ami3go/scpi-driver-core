...
from py_ea_ps9000t.driver import EaPs9000T
from py_ea_ps9000t.exceptions import EaPs9000TError  # noqa: E402
...
TOLERATED = (EaPs9000TError, NotImplementedError,)


def make() -> EaPs9000T:
    return EaPs9000T.connect_simulated()
...
def test_the_public_surface_is_not_empty() -> None:
    ...
    assert len(conformance.public_members(EaPs9000T)) > 10
...
def test_documentation_debt_does_not_grow() -> None:
    ...
    assert len(conformance.undocumented(EaPs9000T)) <= recorded
