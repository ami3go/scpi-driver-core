"""Robot Framework adapter for :mod:`py_ea_ps9000t`.
...
from py_ea_ps9000t import EaPs9000T
from py_ea_ps9000t.exceptions import EaPs9000TConnectionError, EaPs9000TValidationError
...
class EaPs9000TLibrary:
    ...
    def set_lan_dns2(self, address: str, alias: str | None = None) -> None:
        """Anybus modules only (task §9); see ``py_ea_ps9000t.driver.EaPs9000T.set_lan_dns2``."""
