...
├── py_ea_ps9000t/                # hardware-agnostic core driver
│   ├── __init__.py
│   ├── exceptions.py
│   ├── enums.py
│   ├── models.py
...
- **`py_ea_ps9000t`** — hardware-agnostic core. Owns all SCPI command construction and
...
- [ ] Core driver (`py_ea_ps9000t`) implements connection lifecycle **with explicit
