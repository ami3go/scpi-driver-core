...
from keysight_n6700.exceptions import N6700CommandError, N6700ConnectionError
from keysight_n6700.transport import PyVisaTransport, RawSocketTransport
...
def test_visa_timeout_becomes_the_drivers_own_error(fake_visa: None) -> None:
    from keysight_n6700.exceptions import N6700TimeoutError
...
def test_tcp_reports_clear_as_unsupported(loopback: LoopbackInstrument) -> None:
    ...
    from keysight_n6700.exceptions import UnsupportedFeatureError
...
def test_manufacturer_policy_still_lives_in_the_driver(fake_visa: None) -> None:
    ...
    from keysight_n6700.scpi import parse_idn
...
def test_channel_list_syntax_stayed_device_specific() -> None:
    ...
    from keysight_n6700.scpi import format_channel_list, parse_channel_list
