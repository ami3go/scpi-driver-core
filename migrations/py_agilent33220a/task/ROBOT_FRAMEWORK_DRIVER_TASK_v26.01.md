...
arbitrary waveform generator, built on a new typed Python core driver (`py_agilent33220a`)
...
├── py_agilent33220a/           new typed core driver: transport, SCPI, arb waveform helpers
...
2. **Typed Python driver layer** (`py_agilent33220a`) — SCPI formatting/parsing, output/
