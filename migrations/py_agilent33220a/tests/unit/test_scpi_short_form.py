...
from py_agilent33220a.scpi_aliases import CANONICAL_HEADERS
from py_agilent33220a.simulator import SimAgilent33220AInstrument

ROUTES = SimAgilent33220AInstrument._ROUTES
